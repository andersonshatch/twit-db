...
class IDQueryBuilderTest extends PHPUnit_Framework_TestCase {
	private static $select = 'SELECT id, created_at, source, text, retweeted_by_screen_name, retweeted_by_user_id, place_full_name, user_id, entities_json, screen_name, name, profile_image_url';
